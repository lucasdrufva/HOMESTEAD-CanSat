...
class Telemetry(Process):
    ...
    def parse_radio_payload(self, data: str):
        ...
        if data[0] == 3: #Battery
           ...
           voltage = data[5] + (data[6]<<8) + (data[7]<<16) + (data[8]<<24) 
           self.telemetry_data["battery"] = {"mission_time":time, "voltage": voltage+2}
            ...
            self.telemetry_data["gnss_meta"] = {"mission_time":time, "gps_sats_in_use": [2, 5, 10, 13, 15, 18, 23, 24, 27], "glonass_sats_in_use": [69, 70, 79, 85],"sats_in_view": [
                ...
                {"sat_type": "GPS", "elevation": 54, "snr": 26 + random.randrange(-2, 2), "id": 15, "azimuth": 480},
                {"sat_type": "GPS", "elevation": 46, "snr": 35 + random.randrange(-2, 2), "id": 24, "azimuth": 256},
                {"sat_type": "GPS", "elevation": 33, "snr": 28 + random.randrange(-2, 2), "id": 2, "azimuth": 64},
                {"sat_type": "GPS", "elevation": 31, "snr": 35 + random.randrange(-2, 2), "id": 10, "azimuth": 320},
                {"sat_type": "GPS", "elevation": 24, "snr": 19 + random.randrange(-2, 2), "id": 13, "azimuth": 416},
                {"sat_type": "GPS", "elevation": 18, "snr": 22 + random.randrange(-2, 2), "id": 27, "azimuth": 352},
                {"sat_type": "GPS", "elevation": 15, "snr": 27 + random.randrange(-2, 2), "id": 5, "azimuth": 160},
                {"sat_type": "GPS", "elevation": 8, "snr": 18 + random.randrange(-2, 2), "id": 0, "azimuth": 0},
                {"sat_type": "GLONASS", "elevation": 58, "snr": 28 + random.randrange(-2, 2), "id": 85, "azimuth": 128},
                {"sat_type": "GLONASS", "elevation": 57, "snr": 21 + random.randrange(-2, 2), "id": 70, "azimuth": 160},
                {"sat_type": "GLONASS", "elevation": 40, "snr": 32 + random.randrange(-2, 2), "id": 69, "azimuth": 128},
                {"sat_type": "GLONASS", "elevation": 24, "snr": 31 + random.randrange(-2, 2), "id": 79, "azimuth": 448},
                {"sat_type": "GLONASS", "elevation": 16, "snr": 23 + random.randrange(-2, 2), "id": 78, "azimuth": 416},
                {"sat_type": "GLONASS", "elevation": 14, "snr": 20 + random.randrange(-2, 2), "id": 71, "azimuth": 192}
            ]}
